...
Retrieves the results of an asynchronous operation using the task ID. This catalog request allows you to check the status and retrieve the results of async operations initiated by other catalog requests such as Fetch Inbox Async.
...
- [Fetch Inbox Async](FetchInboxAsync.md) - Initiate async inbox retrieval
- [Send Alert Using Notification Delta](SendAlertUsingNotificationDelta.md) - Async notification operations
- [Check If Triggered Mail Ids Exist](CheckIfTriggeredMailIdsExist.md) - Async validation operations
- [Test Connection](TestConnection.md) - Verify connectivity before async operations
...
- [Fetch Inbox Async](FetchInboxAsync.md) - Initiate async operations
- [Test Connection](TestConnection.md) - Verify system connectivity
