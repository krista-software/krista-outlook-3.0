...
Retrieves the most recent email received within the last two minutes. This catalog request is designed for real-time
email monitoring and immediate processing of newly arrived messages.
...
- [Fetch Mail Details By Query](pages/FetchMailDetailsByQuery.md) - Search for specific emails
...
- [Send Alert Using Notification Delta](pages/SendAlertUsingNotificationDelta.md) - Real-time webhook notifications
- [Fetch Inbox](pages/FetchInbox.md) - General inbox email retrieval
