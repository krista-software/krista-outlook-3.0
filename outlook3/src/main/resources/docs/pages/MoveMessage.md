...
Moves an email message from one folder to another using the message ID and destination folder name. This catalog request allows you to organize emails by moving them between different folders in the mailbox.
...
- [Fetch All Labels](FetchAllLabels.md) - Get list of available folders for moving
- [Fetch Mail By Message Id](FetchMailByMessageId.md) - Get email details before moving
- [Mark Message](MarkMessage.md) - Mark emails before or after moving
- [Fetch Mails By Label](FetchMailsByLabel.md) - Verify emails in destination folder
...
- [Fetch All Labels](FetchAllLabels.md) - Get available folders
