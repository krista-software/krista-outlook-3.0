...
Sends real-time email alerts based on notification delta changes in the mailbox. This catalog request provides webhook-based email notifications for immediate processing of new emails, changes, or specific events in the user's mailbox.
...
- [Check If Triggered Mail Ids Exist](CheckIfTriggeredMailIdsExist.md) - Validate triggered emails
- [Fetch Latest Mail](FetchLatestMail.md) - Get recent emails for processing
- [Health Check](HealthCheck.md) - Monitor webhook and alert system health
- [Test Connection](TestConnection.md) - Verify webhook connectivity
...
- **Method**: sendAlertUsingNotificationDelta(String notificationType, String deltaToken, String alertRecipients, String alertSubject)
...
- [Extension Configuration](ExtensionConfiguration.md) - Setup webhook configuration
- [Authentication](Authentication.md) - Authentication for webhook operations
- [Check If Triggered Mail Ids Exist](CheckIfTriggeredMailIdsExist.md) - Validate triggered emails
- [Health Check](HealthCheck.md) - Monitor alert system health
