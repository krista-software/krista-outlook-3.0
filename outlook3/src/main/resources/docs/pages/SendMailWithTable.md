...
Sends email messages with dynamically generated HTML tables from entity data. This catalog request automatically converts entity lists into formatted HTML tables within email content, perfect for sending structured data reports, summaries, and data-driven communications.
...
- [Send Mail](SendMail.md) - Basic email sending without tables
- [Reply To Mail](ReplyToMail.md) - Reply to existing emails
- [Fetch Inbox](FetchInbox.md) - Retrieve emails for processing
- [Test Connection](TestConnection.md) - Verify email sending capabilities
...
- **Method**: sendMailWithTable(String subject, String message, String to, String cc, String bcc, String replyTo, List<File> attachments, List<Entity> entityList, List<String> removeEntityFieldFromTable)
...
- [Send Mail](SendMail.md) - Basic email sending functionality
