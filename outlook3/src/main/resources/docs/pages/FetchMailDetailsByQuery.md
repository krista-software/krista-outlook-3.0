...
Searches for emails using advanced query syntax and returns detailed email information. This catalog request allows you
to find specific emails based on content, sender, subject, or other criteria with comprehensive search capabilities.
...
- [Fetch Sent](pages/FetchSent.md) - Get sent emails
- [Fetch Latest Mail](pages/FetchLatestMail.md) - Get most recent emails
...
- [Fetch Inbox With Preferences](pages/FetchInboxWithPreferences.md) - Advanced filtering
- [Fetch Inbox](pages/FetchInbox.md) - Browse inbox emails
