...
Initiates asynchronous retrieval of emails from the user's inbox for large datasets. This catalog request is designed
for processing large volumes of emails without blocking operations, returning a task ID that can be used to retrieve
results later.
...
- [Fetch Inbox](pages/FetchInbox.md) - Synchronous inbox retrieval
- [Fetch Inbox With Preferences](pages/FetchInboxWithPreferences.md) - Filtered inbox retrieval
- [Test Connection](pages/TestConnection.md) - Verify system connectivity before async operations
...
- [Get Result](pages/GetResult.md) - Retrieve async operation results
- [Fetch Inbox](pages/FetchInbox.md) - Synchronous inbox retrieval
