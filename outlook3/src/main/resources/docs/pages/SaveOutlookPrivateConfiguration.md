...
Configures the Outlook3 Extension for Private Authentication mode using your own Azure AD application. This catalog request sets up enterprise-grade authentication with full OAuth 2.0 implementation, providing complete control over security policies and compliance requirements.
...
1. Complete Azure AD application registration (see [Creating Outlook App](CreatingOutlookApp.md))
...
- [Test Connection](TestConnection.md) - Verify configuration
- [Health Check](HealthCheck.md) - Monitor configuration health
...
- **Method**: savePrivateConfiguration(String email, String clientId, String clientSecret, String tenantId, Boolean allowAlertMail)
...
- [Authentication](Authentication.md) - Authentication flows and troubleshooting
- [Creating Outlook App](CreatingOutlookApp.md) - Azure AD application setup
- [Test Connection](TestConnection.md) - Verify configuration
