...
Retrieves emails from the user's inbox with optional pagination support. This catalog request provides comprehensive
access to inbox emails with configurable page sizes and page numbers for efficient email processing and management.
