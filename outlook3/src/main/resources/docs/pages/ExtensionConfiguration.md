...
3. Test the connection using the [Test Connection](TestConnection.md) catalog request
...
1. Check the [Authentication](Authentication.md) guide for detailed troubleshooting
2. Review the [Creating Outlook App](CreatingOutlookApp.md) guide for Azure AD setup
3. Use the [Test Connection](TestConnection.md) catalog request for diagnostics
4. Contact your Krista administrator for additional support

## Next Steps

After successful configuration:
1. **Test Your Setup**: Use the [Test Connection](TestConnection.md) catalog request
2. **Explore Catalog Requests**: Start with basic operations like [Fetch Inbox](FetchInbox.md)
...
- [Authentication](Authentication.md) - Detailed authentication flows and troubleshooting
- [Creating Outlook App](CreatingOutlookApp.md) - Azure AD application setup guide
- [Test Connection](TestConnection.md) - Connection testing and validation
- [Send Mail](SendMail.md) - Start with basic email sending functionality
