...
Sends new email messages with comprehensive recipient management, attachment support, and flexible content formatting. This catalog request provides full email composition capabilities with advanced recipient handling including To, CC, BCC, and Reply-To fields.
...
- [Send Mail With Table](SendMailWithTable.md) - Send emails with dynamic HTML tables
- [Reply To Mail](ReplyToMail.md) - Reply to existing emails
- [Reply To All](ReplyToAll.md) - Reply to all recipients of an email
...
- **Method**: sendMail(String subject, String message, List<File> attachments, String to, String cc, String bcc, String replyTo, String bodyType)
...
- [Send Mail With Table](SendMailWithTable.md) - Advanced email with tables
