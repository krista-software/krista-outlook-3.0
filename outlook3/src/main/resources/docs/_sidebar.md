...
* 📚 **Getting Started**
  ...
  * ⚙️ [Extension Configuration](pages/ExtensionConfiguration.md)
  * 🔐 [Authentication](pages/Authentication.md)
  * 🔑 [Creating Outlook App](pages/CreatingOutlookApp.md)

* 📧 **Email Management**
  * 📤 [Send Mail](pages/SendMail.md)
  * 📊 [Send Mail With Table](pages/SendMailWithTable.md)
  * ↩️ [Reply To Mail](pages/ReplyToMail.md)
...
* 🔍 **Query Operations**
  ...
  * ⚙️ [Fetch Inbox With Preferences](pages/FetchInboxWithPreferences.md)
...
* 📋 **Message Management**
  * 🏷️ [Mark Message](pages/MarkMessage.md)
  * 📂 [Mark Message Category And Status](pages/MarkMessageCategoryAndStatus.md)
  * 🏷️ [Add Category To Message](pages/AddCategoryToMessage.md)
