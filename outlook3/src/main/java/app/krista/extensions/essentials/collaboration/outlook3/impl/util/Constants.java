...
public class Constants {
    ...
    public static final String EMPTY_STRING = "";
     public static final String INVALID_MAIL_ADDRESS = "Invalid email address format. Please use the format: user@example.com";
    public static final String ONE_INVALID_MAIL = "One or more email addresses are invalid. Please verify all addresses follow the format: user@example.com";
    public static final String REPLY_TO_ALL_REQUEST_FAILED = "Failed to send reply to all recipients. Please verify all email addresses are valid and try again.";
    public static final String INVALID_MESSAGE_ID = "Message not found. It may have been deleted or moved. Please refresh your inbox and select a valid message.";
    public static final String INCORRECT_FOLDER_NAME = "Folder not found in your mailbox. Please verify the folder name. Common folders: Inbox, Sent Items, Drafts, Archive.";
    public static final String READ = "read";
    public static final String UNREAD = "unread";
    public static final String MARK_MESSAGE_REQUEST_FAILED = "Failed to update message status. The message may have been deleted. Please refresh and try again.";
    public static final String FETCH_MAIL_FAILED_NO_FOLDER = "Folder not found in your mailbox. Please verify the folder name or create it first. Common folders: Inbox, Sent Items, Drafts, Archive.";
    ...
    public static final String FOLDER_NAME_NOT_FOUND = "Folder not found in your mailbox. Please verify the folder name or create it first.";
    public static final String FOLDER_NAME_IS_EMPTY_OR_NULL = "Folder name is required. Please enter a folder name.";
    public static final String MESSAGE_ID_IS_EMPTY_OR_NULL = "Message ID is required. Please provide a valid message ID.";
    public static final String FOLDER_ID_IS_NULL_OR_EMPTY = "Folder ID is required. Please provide a valid folder ID.";
    public static final String EMAIL_ADDRESS_IS_EMPTY_OR_NULL = "Email address is required. Please enter an email address.";
    public static final String RECIPIENT_IS_EMPTY_OR_NULL = "At least one recipient is required. Please add a recipient email address.";
    ...
    public static final String UNAUTHORISED_USER = "Access denied. You don't have permission to access this resource. Please contact your administrator.";
    public static final String USER_AUTHENTICATED_SUCCESSFULLY_SAVE_THE_CHANGES = "Authentication successful! Click 'Save' to complete the setup.";
    public static final String ERROR_OCCURRED_DURING_AUTHORIZATION = "Authentication failed. Please try again or contact your administrator if the issue persists.";
    ...
    public static final String FAILED_TO_SEARCH_FOR_LABELS = "Failed to retrieve folder labels. Please refresh your mailbox and try again.";
    ...
    public static final String SEND_MAIL_REQUEST_FAILED = "Failed to send message. Please verify:\n• All recipient email addresses are valid\n• Your mailbox has sufficient storage space";
    public static final String SEND_MAIL_WITH_TABLE_REQUEST_FAILED = "Failed to send message with table. Please verify the table data is properly formatted and try again.";
    public static final String REPLY_TO_MAIL_REQUEST_FAILED = "Failed to send reply. Please verify the original message still exists and try again.";
    ...
    public static final String UNSUPPORTED_AUTH = "Unsupported authentication type. Please choose 'Public' (user authentication) or 'Private' (service account authentication).";
    public static final String REFRESH_TOKEN_EXPIRED = "Session expired. Please click 'Authorize' to sign in again.";
    public static final String FAILED_TO_GET_ACCOUNT = "Failed to retrieve account information. Please verify:\n• You're signed in with the correct account\n• Your account has the necessary permissions";
    public static final String EXTENSION_FORWARD_PATH = "/rest/outlook/v3/oauth/callback";
    public static final String ERROR_OCCURRED_DURING_FETCHING_ATTACHMENTS = "Failed to download one or more attachments. The attachment may be too large or corrupted.";
    public static final String FAILED_TO_MARK_THE_MESSAGE_AS_READ = "Failed to update message status. The message may have been deleted or moved. Please refresh and try again.";
    public static final String FAILED_TO_MOVE_MESSAGE = "Failed to move message. Please verify:\n• The destination folder exists\n• The message hasn't been deleted\n• You have permission to move messages";
    ...
    public static final String NOT_FOUND = "' not found. It may have been deleted or renamed. Please verify the folder ID or refresh your folder list.";
    public static final String NO_MESSAGE_FOUND_FOR_MESSAGE_ID = "Message not found with ID: ";
    public static final String GOT_ERROR_FOR_AUTHENTICATION_SO_SENDING_FOR_RE_AUTHENTICATION = "Authentication expired. Please sign in again.";
    public static final String GOT_ERROR_FOR_AUTHENTICATION_SO_SENDING_FOR_AUTHENTICATION = "Authentication required. Please sign in to continue.";
    ...
    public static final String USER_DELETED_ERROR = "Microsoft account no longer exists. Please contact your administrator.";
    public static final String USER_DISABLED_ERROR = "Microsoft account is blocked or locked. Please contact your administrator.";
    ...
    public static final String PERMISSIONS_REVOKED_ERROR = "Access permissions have been revoked. Please contact your administrator to restore access.";
    public static final String REFRESH_TOKEN_EXPIRED_ERROR = "Session expired. Please re-authorize to continue.";
    ...
    public static final String SERVICE_UNAVAILABLE_ERROR = "Microsoft services are temporarily unavailable. Please try again later.";
    ...
    public static final String PASSWORD_CHANGED_ERROR = "Microsoft password was recently changed. Please re-authorize with your new password.";
